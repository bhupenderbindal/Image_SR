...
from src.losses import lpipss as lpips
...
class LPIPS(nn.Module):
    def __init__(self, net='alex', version='0.1', lpips=True, spatial=False, 
        ...
        pretrained : bool -- removed and using default weights now
