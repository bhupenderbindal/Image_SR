...
"""
It is not much useful when the color profile of patches are different itself, as it is with cfrp sr images.
can be useful othewise.
"""
import cv2
import numpy as np
...
img = cv2.imread(
    "data/images/N-34-66-C-c-4-3.tif"
)  # N-34-66-C-c-4-3.tif, N-34-97-D-c-2-4.tif
