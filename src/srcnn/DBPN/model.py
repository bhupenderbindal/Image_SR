...
class DBPN(nn.Module):
    def __init__(
        self, num_channels, base_channels, feat_channels, num_stages, scale_factor
    ):
        ...
        self.feat0 = ConvBlock(
            num_channels, feat_channels, 3, 1, 1, activation="prelu", norm=None
        )
        self.feat1 = ConvBlock(
            feat_channels, base_channels, 1, 1, 0, activation="prelu", norm=None
        )
